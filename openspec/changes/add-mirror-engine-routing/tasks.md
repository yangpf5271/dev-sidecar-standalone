...
- [x] 3.1 npm.js 镜像段改薄：NPM_MIRRORS 表 + 引擎调用 + 工具特有文案（发布警示/代理冲突提醒）逐字保留
- [x] 3.2 pip.js 镜像段改薄：同上；行为与输出逐字对照（切换/恢复/查看三命令）
- [x] 3.3 现有 CI mirror switch 断言原样保持绿；本地 npm/pip 镜像往返冒烟
